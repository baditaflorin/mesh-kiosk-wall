...
[![pages](https://img.shields.io/badge/live-baditaflorin.github.io%2Fmesh-kiosk-wall-00aaff)](https://baditaflorin.github.io/mesh-kiosk-wall/)
[![version](https://img.shields.io/badge/version-0.1.0-blue)](https://github.com/baditaflorin/mesh-kiosk-wall/blob/main/package.json)
[![license](https://img.shields.io/badge/license-MIT-green)](./LICENSE)

> Turn an old phone into a shop-window display. Peers submit; wall cycles.

**Live → https://baditaflorin.github.io/mesh-kiosk-wall/**

**Source → https://github.com/baditaflorin/mesh-kiosk-wall**
...
git clone https://github.com/baditaflorin/mesh-kiosk-wall
cd mesh-kiosk-wall
npm install
npm run dev
```
...
- `mesh-kiosk-wall:signalingUrl`
- `mesh-kiosk-wall:turnTokenUrl`
- `mesh-kiosk-wall:iceServers`
- `mesh-kiosk-wall:room`
